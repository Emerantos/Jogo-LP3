...
public class Game extends JPanel {
    ...
    public Game(){
		...
		//criar uma verificação para quando dectar uma colição ele parar a geração de obstaculos
			}
	...
	public void criarObstaculo() {
		obstaculos.add(new Obstaculo(999, 550));
	}
	
	public void criarObstaculoVoador() {
		obstaculos.add(new ObstaculoVoador(999, 450));
	}
}
